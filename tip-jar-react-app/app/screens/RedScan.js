...
function RedScan({navigation}) {
    ...
    const handleBarCodeScanned = ({ type, data }) => {
      ...
      console.log(`Bar code with type ${type} and data ${data} has been scanned!`);
        ...
        fetch('https://tipjargold.a8mnj2x1n5f.eu-de.codeengine.appdomain.cloud/redscan',{
          method: 'POST',
    ...
    return (
      ...
      <View style={{width: "100%", height: 90, justifyContent: "center", alignItems: "center", backgroundColor: "red"}}>
        <Text style={{fontFamily: "Menlo", fontSize: 30, fontWeight: "bold"}} numberOfLines={1}>Scan Red Bin QR Code</Text>
    ...
    <View style={{top: 25, height: 150, flexDirection: "row"}}>
        ...
        <RedPayload1 />
        <TouchableOpacity onPress={() => navigation.navigate("Red Step 2")} style={{left: 255,justifyContent: "center", bottom: 10, width: 300, height: 80, backgroundColor: "mistyrose", borderWidth: 1, borderRadius: 15, borderColor: "white" }}>
