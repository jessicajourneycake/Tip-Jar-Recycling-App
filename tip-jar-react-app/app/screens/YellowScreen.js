...
export default class YellowScreen extends Component {
  ...
  componentDidMount() {
    fetch('https://service.us.apiconnect.ibmcloud.com/gws/apigateway/api/66588c677e52fcdad4215271baa6da14d9cf59984c8b24e91c2318465f391743/j7yIzm/Yellow', {
      method: 'GET',
...
<>
         ...
         <View style={{height: 70, backgroundColor: "yellow", justifyContent: "center", alignItems: "center"}}>
            <Text style={{color: "blac", fontFamily: "Menlo", fontSize: 26}}>Yellow Bin: Kraft Heinz</Text>
        </View>
