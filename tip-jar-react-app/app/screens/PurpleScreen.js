...
import PurpleClear from "../components/PurpleClear";
...
export default class PurpleScreen extends Component {
  ...
  componentDidMount() {
    fetch('https://service.us.apiconnect.ibmcloud.com/gws/apigateway/api/66588c677e52fcdad4215271baa6da14d9cf59984c8b24e91c2318465f391743/j7yIzm/Purple', {
      method: 'GET',
...
<>
         ...
         <View style={{height: 70, backgroundColor: "purple", justifyContent: "center", alignItems: "center"}}>
            <Text style={{color: "white", fontFamily: "Menlo", fontSize: 26}}>Purple Bin: Unilever</Text>
        </View>
      
        <View>
        <ImageBackground style={{width: 500, height: 190, right: 50, resizeMode: "contain"}}source={require('../assets/back.png')}>
