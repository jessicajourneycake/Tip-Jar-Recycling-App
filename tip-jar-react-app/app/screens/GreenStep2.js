...
import GreenPayload2 from "../components/GreenPayload2";
...
function GreenStep2(props) {
    ...
    const handleBarCodeScanned = ({ type, data }) => {
      ...
      console.log(`Bar code with type ${type} and data ${data} has been scanned!`);
        ...
        fetch('https://tipjargold.a8mnj2x1n5f.eu-de.codeengine.appdomain.cloud/greenbarcode',{
          method: 'POST',
    ...
    <View style={{top: 120, height: 260, flexDirection: "row"}}>
