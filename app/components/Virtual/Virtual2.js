...
export default class Virtual2 extends React.Component {
    ...
    componentDidMount() {
        var socket = new WebSocket('wss://tipjarjess.mybluemix.net/ws/virtual2');
    ...
    render() {
        ...
        return (
            ...
            <View>
            <Image source={{uri: this.state.echo[3]}} style={{height: 50, width: 50}}/>
            </View>
            <View style={{justifyContent: "center"}}>
            <Text style={{width: 70, height: 20, paddingLeft: 30, color: "blue"}} numberOfLines={3}>{this.state.echo[4]}</Text>
            </View>
