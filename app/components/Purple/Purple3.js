...
export default class Purple3 extends React.Component {
    ...
    componentDidMount() {
        var socket = new WebSocket('wss://tipjargold.a8mnj2x1n5f.eu-de.codeengine.appdomain.cloud/ws/purple3');
    ...
    render() {
        ...
        return (
            ...
            <View>
                <Text style={{fontFamily: "Menlo", width: 160, height: 40, paddingLeft: 15}} numberOfLines={2}>{this.state.echo[1]}</Text>
                </View>  
            <View style={{paddingLeft: 15}}>
            <Image source={{uri: this.state.echo[2]}} style={{resizeMode: "contain", height: 50, width: 50 }}/>
            </View>
            <Text style={{fontFamily: "Menlo", fontWeight: "bold", width: 80, height: 20, left: 35}} numberOfLines={3}>{this.state.echo[4]}</Text>
