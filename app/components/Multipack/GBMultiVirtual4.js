...
export default class GBMultiVirtual4 extends React.Component {
    ...
    componentDidMount() {
        var socket = new WebSocket('wss://tipjargold.a8mnj2x1n5f.eu-de.codeengine.appdomain.cloud/ws/multivirtual4');
