...
export default class InUse0 extends React.Component {
    ...
    componentDidMount() {
        var socket = new WebSocket('wss://tipjarjess.mybluemix.net/ws/inuse0');
    ...
    render() {
        ...
        return (
            ...
            <View>
            <Text style={{width: 230, height: 40, paddingLeft: 10}} numberOfLines={2}>{this.state.echo[1]}</Text>
            </View>
