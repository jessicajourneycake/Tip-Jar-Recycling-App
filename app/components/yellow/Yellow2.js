...
export default class Yellow2 extends React.Component {
    ...
    componentDidMount() {
        var socket = new WebSocket('wss://tipjargold.a8mnj2x1n5f.eu-de.codeengine.appdomain.cloud/ws/yellow2');
    ...
    render() {
        ...
        return (
            ...
            <View>
            <Text style={{fontFamily: "Menlo", fontWeight: "bold",left: 40, width: 80, height: 20,}} numberOfLines={3}>{this.state.echo[4]}</Text>
            </View>
            </View>
            </SafeAreaView>
