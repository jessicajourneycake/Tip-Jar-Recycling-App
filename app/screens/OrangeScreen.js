...
import OrangeClear from "../components/OrangeClear";





export default class OrangeScreen extends Component {
  constructor(props){
    super(props)
    this.state = {
      isLoading: true,
  ...
  componentDidMount() {
    fetch('https://service.us.apiconnect.ibmcloud.com/gws/apigateway/api/66588c677e52fcdad4215271baa6da14d9cf59984c8b24e91c2318465f391743/j7yIzm/Orange', {
      method: 'GET',
...
<>
         ...
         <View style={{height: 70, backgroundColor: "orange", justifyContent: "center", alignItems: "center"}}>
            <Text style={{color: "black", fontFamily: "Menlo", left: 10, width: 400, justifyContent: "center", fontSize: 22}}>Orange Bin: To-Go Reusable Cups & Containers</Text>
        </View>
      
        <View>
        <ImageBackground style={{width: 500, height: 200, right: 50, resizeMode: "contain"}}source={require('../assets/back.png')}>
  <OrangeClear />
