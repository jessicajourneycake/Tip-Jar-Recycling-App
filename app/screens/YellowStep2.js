...
import YellowPayload2 from "../components/YellowPayload2";

function YellowStep2(props) {
    ...
    const handleBarCodeScanned = ({ type, data }) => {
      ...
      console.log(`Bar code with type ${type} and data ${data} has been scanned!`);
        ...
        fetch('https://tipjargold.a8mnj2x1n5f.eu-de.codeengine.appdomain.cloud/yellowbarcode',{
          method: 'POST',
