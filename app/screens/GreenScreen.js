...
<>
         ...
         <View style={{flexDirection: "column", height: 70, backgroundColor: "green", justifyContent: "center", alignItems: "center"}}>
            <Text style={{top: 15, right: 25, color: "white", fontFamily: "Menlo", fontSize: 18}}>Green Bin: Proctor & Gamble</Text>
        </View>
