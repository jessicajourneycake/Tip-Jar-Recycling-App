...
import PurplePayload2 from "../components/PurplePayload2";

function PurpleStep2(props) {
    ...
    const handleBarCodeScanned = ({ type, data }) => {
      ...
      console.log(`Bar code with type ${type} and data ${data} has been scanned!`);
        ...
        fetch('https://tipjargold.a8mnj2x1n5f.eu-de.codeengine.appdomain.cloud/purplebarcode',{
          method: 'POST',
